...
export default function App() {
  ...
  if (loadingCSV || processing) return (
    <div style={{ minHeight:"100vh", background:"#faf9f7", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", fontFamily:"'Inter',sans-serif" }}>
      ...
      <div style={{ fontFamily:"'Outfit',sans-serif", fontSize:28, fontWeight:700, color:"#1a1a2e", marginBottom:8 }}>{fileName}</div>
  ...
  if (!data.length) return (
    <div style={{ minHeight:"100vh", background:"#faf9f7", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", fontFamily:"'Inter',sans-serif", padding:40 }}>
      ...
      <div style={{ marginTop:32, width:"100%", maxWidth:480 }}>
        <div style={{ fontSize:10, fontFamily:"'JetBrains Mono',monospace", color:"#aaa", textTransform:"uppercase", letterSpacing:"0.12em", marginBottom:8 }}>
        ...
        {urlError && (
          <div style={{ marginTop:8, fontSize:12, color:"#991b1b", fontFamily:"'JetBrains Mono',monospace" }}>{urlError}</div>
        )}
        <div style={{ marginTop:6, fontSize:11, color:"#bbb", fontFamily:"'JetBrains Mono',monospace" }}>
      ...
      <div style={{ display:"flex", alignItems:"center", gap:16, margin:"28px 0", width:"100%", maxWidth:480 }}>
        ...
        <span style={{ fontSize:11, fontFamily:"'JetBrains Mono',monospace", color:"#bbb" }}>ou upload direto</span>
        <div style={{ flex:1, height:1, background:"#e8e4de" }}/>
      </div>
  ...
  return (
    <>
      <div style={{ position:"fixed", bottom:24, right:24, zIndex:9999, display:"flex", gap:6, background:"#fff", padding:6, borderRadius:14, boxShadow:"0 4px 20px rgba(0,0,0,0.14)" }}>
        ...
        {sourceUrl && (
          <button onClick={refresh} title="Recarregar dados da fonte" style={{ padding:"9px 14px", borderRadius:10, border:"none", cursor:"pointer", fontFamily:"'Inter',sans-serif", fontSize:13, background:"transparent", color:"#2d6a4f", fontWeight:600, transition:"all 0.15s" }}>
            ↻ Atualizar
          </button>
        )}
      </div>
